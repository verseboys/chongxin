		...
		<div class="pageFormContent" layoutH="56">
			<#if accountId==0>
				<dl class="nowrap">
					<dt>合作伙伴：</dt>
					<dd>
						<input names="company.id" class="required" name="companyid" value="0" type="hidden"/>
						<input class="required" readonly="readonly" value="" names="company.name" type="text" lookupGroup="company"/>
			...
			<p>
				<label>价格：</label>
				<input type="text" name="price" size="20" class="required"/>
				<select name="units">
					<option selected="selected" value="元/次">元/次</option>
