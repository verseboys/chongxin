<div class="pageHeader">
	<form id="pagerForm" onsubmit="return navTabSearch(this);" action="/admin/ask" method="post">
		...
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>
						问题：<input type="text" name="title" value="${title?if_exists}"/>
					</td>
				</tr>
			</table>
			<div class="subBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="/admin/ask/shenchaask?id={sid_user}" target="navTab" warn="请选择记录！"><span>审查问题</span></a></li>
			<li><a class="edit" href="/admin/ask/answerlist?id={sid_user}" target="navTab" warn="请选择记录！"><span>查看回答</span></a></li>
		</ul>
	</div>
	<div id="w_list_print">
		<table class="table" width="100%" layoutH="138">
			<thead>
				<tr>
					<th width="100" align="center">问题</th>
					<th width="100" align="center">用户昵称</th>
					<th width="100" align="center">创建时间</th>
					<th width="20" align="center">审查问题</th>
					<th width="20" align="center">查看回答</th>
				</tr>
			</thead>
			<tbody>
				<#if beans?exists && beans?size gt 0>
					<#list beans as ls>
						<tr target="sid_user" rel="${(ls.id)?if_exists}">
							...
							<td>
								<a title="审查问题" target="navTab" href="/admin/ask/shenchaask?id=${(ls.id)?if_exists}" class="btnEdit">审查动态</a>
							</td>
							<td>
								<a title="查看回答" target="navTab" href="/admin/ask/answerlist?id=${(ls.id)?if_exists}" class="btnEdit">查看评论</a>
							</td>
						</tr>
					</#list>
				</#if>
