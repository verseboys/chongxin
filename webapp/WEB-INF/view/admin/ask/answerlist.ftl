<div class="pageHeader">
	<form id="pagerForm" onsubmit="return navTabSearch(this);" action="/admin/ask/answerlist" method="post">
		...
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>
						回复：<input type="text" name="title" value="${title?if_exists}"/>
					</td>
				</tr>
			</table>
			<div class="subBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="/admin/ask/shenchaanswer?id={sid_user}" target="navTab" warn="请选择记录！"><span>审查回复</span></a></li>
		</ul>
	</div>
	<div id="w_list_print">
		<table class="table" width="100%" layoutH="138">
			<thead>
				<tr>
					<th width="100" align="center">回复</th>
				...
				<#if beans?exists && beans?size gt 0>
					<#list beans as ls>
						<tr target="sid_user" rel="${(ls.id)?if_exists}">
							...
							<td>
								<a title="审查回复" target="navTab" href="/admin/ask/shenchaanswer?id=${(ls.id)?if_exists}" class="btnEdit">审查回复</a>
							</td>
						</tr>
					</#list>
				</#if>
