...
<div class="pageContent">
	<form method="post" action="/admin/ask/deleteanswer" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		...
		<div class="pageFormContent" layoutH="56">
			...
			<div>
				<label>回复图片：</label>
				<#if (bean.answerPics)?exists && (bean.answerPics)?size gt 0>
					<#list (bean.answerPics) as ls><!--list循环-->
