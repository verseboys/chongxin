    ...
    <form method="post" action="/member/doghouse/submit" id="doghouse-form">
	    ...
	    <ul class="forminfo">
	    	<li>
		    	...
		    	<input name="name" type="text" value="${(account.profile.nickName)?if_exists}的宠信店" class="dfinput name"/>
		    </li>
		    <li>
		    	<label>手机或电话<b>*</b></label>
		    	<input name="telephone" type="text" value="${(account.profile.mobile)?if_exists}" class="dfinput telephone" placeholder="010-88888888"/>
		    </li>
		    <li>
		    	<label>地址<b>*</b></label>
		    	<input name="address" type="text" value="${(account.profile.address)?if_exists}" class="dfinput address"/>
		    </li>
		    <li>
		    	<label>所在地区</label>
		    	<input name="district" type="text" value="" class="dfinput"/>
		    </li>
		    <li>
		    	<label>营业时间</label>
		    	<input name="open_time" type="text" value="" class="dfinput"/>
		    </li>
		    <!--
		    <li id="banner">
		    	<label>banner</label>
		    ...
		    <li>
		    	<label>犬舍介绍</label>
		    	<textarea id="content7" name="introduction" style="width:700px;height:250px;"></textarea>
		    </li>
