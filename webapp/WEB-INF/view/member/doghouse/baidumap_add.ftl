...
<body>
	<form id="baidumap-form" action="/member/doghouse/mapupdate" method="post">
		...
		<div style="width:100%;height:5%;">
			...
			<input value="" size="8" name="longtitude" id="longtitude" readOnly="true" style="margin-right:10px;"/>
			<input value="纬度：" size="2" style="border-style:none;margin-right:10px;" readOnly="true"/>
			<input value="" size="8" name="latitude" id="latitude" readOnly="true" style="margin-right:10px;"/>
