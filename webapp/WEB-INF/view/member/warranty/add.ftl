...
<body>
    ...
    <div class="formbody formbody1">
	    ...
	    <form method="post" action="/member/warranty/submit" id="warranty-form">
	    	<input type="hidden" name="createdStr"  value="${created?if_exists}">
		    <ul class="forminfo">
			    <li>
			    	<label>宠物芯片号<b>*</b></label>
			    	<input name="blood" type="text" class="dfinput blood"/>
			    	<b class="error1" style="display:none;">芯片号不能为空！</b><b class="error2" style="display:none;">芯片号不正确，或宠物信息还未录入！</b>
			    </li>
			    <li>
			    	<label>价格<b>*</b></label>
			    	<input name="price" placeholder="正整数" value="0" type="text" class="dfinput price" />
			    </li>
			    <li>
			    	<label>&nbsp;</label>
